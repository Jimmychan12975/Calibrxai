      ...
      <section className="services" style={{ paddingTop: 8 }}>
        <div className="services-grid grid-4">
          <div className="service-card">
            <img src="/Calipet_Hero_Image.png" alt="Calipet dashboard showing nutrition progress with friendly pet characters" style={{ width: "100%", borderRadius: 8, display: "block" }} />
          ...
          <div className="service-card">
            <img src="/Calipet_Character_Progression.png" alt="Calipet character progression from Level 1 to Level 4 with XP rewards" style={{ width: "100%", borderRadius: 8, display: "block" }} />
            <div className="service-content">
          ...
          <div className="service-card">
            <img src="/Calipet_Meal_Scanning_Feature.png" alt="Phone scanning a plate of food with AI estimating macros and calories" style={{ width: "100%", borderRadius: 8, display: "block" }} />
            <div className="service-content">
          ...
          <div className="service-card">
            <img src="/Calipet_Advertisement_Banner.png" alt="Feed your pet, feed your health banner with pets and food diary" style={{ width: "100%", borderRadius: 8, display: "block" }} />
            <div className="service-content">
