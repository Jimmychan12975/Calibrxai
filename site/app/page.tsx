  ...
  return (
    <>
      ...
      <section className="hero" id="home">
        ...
        <img src="/Calibrx_AI_Hero_Image.png" alt="AI Building Blocks" className="hero-image" />
      ...
      <section className="services" id="services">
        ...
        <img src="https://assets-persist.lovart.ai/agent_images/1e2d39e0-6b4d-4d78-9d74-5cdbecd316f0.png" alt="AI Solutions" style={{ width: "100%", marginTop: 60, borderRadius: 8 }} />
      </section>
